...
class StoryScene : IScene
{
    public void Show()
    {
        ...
        AnsiConsole.MarkupLine($"Hours later, you awaken in a jumpship oribiting above the planetoid Nemosa-7, strapped into the seat of an ejection pod. The desolate face of the asteroid fills the windows.");
